...
# 生成数据
def make_noisy_sample(n=120, noise_std=0.35, rng=None):
    if rng is None:
...
# 拟合函数
def fit_degree(x_train, y_train, x_grid, degree):
    model = Pipeline([
...
# 改为英文标题
fig.suptitle("Which Candidate is Most Likely to Fail in Real World?", y=1.05, fontsize=14)
plt.tight_layout()
plt.show()
```
...
ax.set_ylabel("RMSE")
ax.set_title("Complete Performance: Who Has the Best Test Performance?")  # 改为英文
ax.legend()
plt.tight_layout()
plt.show()
...
![png](output_10_0.png)
    ...
    0      10    0.323097   0.306806           -0.016291
    1       9    0.324928   0.306964           -0.017965
    2       7    0.326069   0.307250           -0.018819
    3       8    0.324941   0.307404           -0.017537
    4       6    0.326965   0.310890           -0.016075
    5       5    0.327246   0.311426           -0.015821
    6       4    0.380895   0.333953           -0.046941
    7       3    0.381746   0.335409           -0.046337
    
    Best test RMSE occurs at degree = 10
...
```
    ...
    /tmp/ipykernel_88258/4211272055.py:31: UserWarning: Glyph 21516 (\N{CJK UNIFIED IDEOGRAPH-540C}) missing from font(s) DejaVu Sans.
      plt.tight_layout()
    /tmp/ipykernel_88258/4211272055.py:31: UserWarning: Glyph 19968 (\N{CJK UNIFIED IDEOGRAPH-4E00}) missing from font(s) DejaVu Sans.
      plt.tight_layout()
    /tmp/ipykernel_88258/4211272055.py:31: UserWarning: Glyph 30495 (\N{CJK UNIFIED IDEOGRAPH-771F}) missing from font(s) DejaVu Sans.
      plt.tight_layout()
    /tmp/ipykernel_88258/4211272055.py:31: UserWarning: Glyph 23454 (\N{CJK UNIFIED IDEOGRAPH-5B9E}) missing from font(s) DejaVu Sans.
      plt.tight_layout()
    /tmp/ipykernel_88258/4211272055.py:31: UserWarning: Glyph 35268 (\N{CJK UNIFIED IDEOGRAPH-89C4}) missing from font(s) DejaVu Sans.
      plt.tight_layout()
    /tmp/ipykernel_88258/4211272055.py:31: UserWarning: Glyph 24459 (\N{CJK UNIFIED IDEOGRAPH-5F8B}) missing from font(s) DejaVu Sans.
      plt.tight_layout()
    /tmp/ipykernel_88258/4211272055.py:31: UserWarning: Glyph 12289 (\N{IDEOGRAPHIC COMMA}) missing from font(s) DejaVu Sans.
      plt.tight_layout()
    /tmp/ipykernel_88258/4211272055.py:31: UserWarning: Glyph 19981 (\N{CJK UNIFIED IDEOGRAPH-4E0D}) missing from font(s) DejaVu Sans.
      plt.tight_layout()
    /tmp/ipykernel_88258/4211272055.py:31: UserWarning: Glyph 35757 (\N{CJK UNIFIED IDEOGRAPH-8BAD}) missing from font(s) DejaVu Sans.
      plt.tight_layout()
    /tmp/ipykernel_88258/4211272055.py:31: UserWarning: Glyph 32451 (\N{CJK UNIFIED IDEOGRAPH-7EC3}) missing from font(s) DejaVu Sans.
      plt.tight_layout()
    /tmp/ipykernel_88258/4211272055.py:31: UserWarning: Glyph 26679 (\N{CJK UNIFIED IDEOGRAPH-6837}) missing from font(s) DejaVu Sans.
      plt.tight_layout()
    /tmp/ipykernel_88258/4211272055.py:31: UserWarning: Glyph 26412 (\N{CJK UNIFIED IDEOGRAPH-672C}) missing from font(s) DejaVu Sans.
      plt.tight_layout()
    /tmp/ipykernel_88258/4211272055.py:31: UserWarning: Glyph 65306 (\N{FULLWIDTH COLON}) missing from font(s) DejaVu Sans.
      plt.tight_layout()
    /tmp/ipykernel_88258/4211272055.py:31: UserWarning: Glyph 35841 (\N{CJK UNIFIED IDEOGRAPH-8C01}) missing from font(s) DejaVu Sans.
      plt.tight_layout()
    /tmp/ipykernel_88258/4211272055.py:31: UserWarning: Glyph 22312 (\N{CJK UNIFIED IDEOGRAPH-5728}) missing from font(s) DejaVu Sans.
      plt.tight_layout()
    /tmp/ipykernel_88258/4211272055.py:31: UserWarning: Glyph 21095 (\N{CJK UNIFIED IDEOGRAPH-5267}) missing from font(s) DejaVu Sans.
      plt.tight_layout()
    /tmp/ipykernel_88258/4211272055.py:31: UserWarning: Glyph 28872 (\N{CJK UNIFIED IDEOGRAPH-70C8}) missing from font(s) DejaVu Sans.
      plt.tight_layout()
    /tmp/ipykernel_88258/4211272055.py:31: UserWarning: Glyph 25238 (\N{CJK UNIFIED IDEOGRAPH-6296}) missing from font(s) DejaVu Sans.
      plt.tight_layout()
    /tmp/ipykernel_88258/4211272055.py:31: UserWarning: Glyph 21160 (\N{CJK UNIFIED IDEOGRAPH-52A8}) missing from font(s) DejaVu Sans.
      plt.tight_layout()
    /tmp/ipykernel_88258/4211272055.py:31: UserWarning: Glyph 65311 (\N{FULLWIDTH QUESTION MARK}) missing from font(s) DejaVu Sans.
      plt.tight_layout()
    /home/user6182/Regression-Analysis-2026/slides/.venv/lib/python3.14/site-packages/IPython/core/pylabtools.py:170: UserWarning: Glyph 21516 (\N{CJK UNIFIED IDEOGRAPH-540C}) missing from font(s) DejaVu Sans.
      fig.canvas.print_figure(bytes_io, **kw)
    /home/user6182/Regression-Analysis-2026/slides/.venv/lib/python3.14/site-packages/IPython/core/pylabtools.py:170: UserWarning: Glyph 19968 (\N{CJK UNIFIED IDEOGRAPH-4E00}) missing from font(s) DejaVu Sans.
      fig.canvas.print_figure(bytes_io, **kw)
    /home/user6182/Regression-Analysis-2026/slides/.venv/lib/python3.14/site-packages/IPython/core/pylabtools.py:170: UserWarning: Glyph 30495 (\N{CJK UNIFIED IDEOGRAPH-771F}) missing from font(s) DejaVu Sans.
      fig.canvas.print_figure(bytes_io, **kw)
    /home/user6182/Regression-Analysis-2026/slides/.venv/lib/python3.14/site-packages/IPython/core/pylabtools.py:170: UserWarning: Glyph 23454 (\N{CJK UNIFIED IDEOGRAPH-5B9E}) missing from font(s) DejaVu Sans.
      fig.canvas.print_figure(bytes_io, **kw)
    /home/user6182/Regression-Analysis-2026/slides/.venv/lib/python3.14/site-packages/IPython/core/pylabtools.py:170: UserWarning: Glyph 35268 (\N{CJK UNIFIED IDEOGRAPH-89C4}) missing from font(s) DejaVu Sans.
      fig.canvas.print_figure(bytes_io, **kw)
    /home/user6182/Regression-Analysis-2026/slides/.venv/lib/python3.14/site-packages/IPython/core/pylabtools.py:170: UserWarning: Glyph 24459 (\N{CJK UNIFIED IDEOGRAPH-5F8B}) missing from font(s) DejaVu Sans.
      fig.canvas.print_figure(bytes_io, **kw)
    /home/user6182/Regression-Analysis-2026/slides/.venv/lib/python3.14/site-packages/IPython/core/pylabtools.py:170: UserWarning: Glyph 12289 (\N{IDEOGRAPHIC COMMA}) missing from font(s) DejaVu Sans.
      fig.canvas.print_figure(bytes_io, **kw)
    /home/user6182/Regression-Analysis-2026/slides/.venv/lib/python3.14/site-packages/IPython/core/pylabtools.py:170: UserWarning: Glyph 19981 (\N{CJK UNIFIED IDEOGRAPH-4E0D}) missing from font(s) DejaVu Sans.
      fig.canvas.print_figure(bytes_io, **kw)
    /home/user6182/Regression-Analysis-2026/slides/.venv/lib/python3.14/site-packages/IPython/core/pylabtools.py:170: UserWarning: Glyph 35757 (\N{CJK UNIFIED IDEOGRAPH-8BAD}) missing from font(s) DejaVu Sans.
      fig.canvas.print_figure(bytes_io, **kw)
    /home/user6182/Regression-Analysis-2026/slides/.venv/lib/python3.14/site-packages/IPython/core/pylabtools.py:170: UserWarning: Glyph 32451 (\N{CJK UNIFIED IDEOGRAPH-7EC3}) missing from font(s) DejaVu Sans.
      fig.canvas.print_figure(bytes_io, **kw)
    /home/user6182/Regression-Analysis-2026/slides/.venv/lib/python3.14/site-packages/IPython/core/pylabtools.py:170: UserWarning: Glyph 26679 (\N{CJK UNIFIED IDEOGRAPH-6837}) missing from font(s) DejaVu Sans.
      fig.canvas.print_figure(bytes_io, **kw)
    /home/user6182/Regression-Analysis-2026/slides/.venv/lib/python3.14/site-packages/IPython/core/pylabtools.py:170: UserWarning: Glyph 26412 (\N{CJK UNIFIED IDEOGRAPH-672C}) missing from font(s) DejaVu Sans.
      fig.canvas.print_figure(bytes_io, **kw)
    /home/user6182/Regression-Analysis-2026/slides/.venv/lib/python3.14/site-packages/IPython/core/pylabtools.py:170: UserWarning: Glyph 65306 (\N{FULLWIDTH COLON}) missing from font(s) DejaVu Sans.
      fig.canvas.print_figure(bytes_io, **kw)
    /home/user6182/Regression-Analysis-2026/slides/.venv/lib/python3.14/site-packages/IPython/core/pylabtools.py:170: UserWarning: Glyph 35841 (\N{CJK UNIFIED IDEOGRAPH-8C01}) missing from font(s) DejaVu Sans.
      fig.canvas.print_figure(bytes_io, **kw)
    /home/user6182/Regression-Analysis-2026/slides/.venv/lib/python3.14/site-packages/IPython/core/pylabtools.py:170: UserWarning: Glyph 22312 (\N{CJK UNIFIED IDEOGRAPH-5728}) missing from font(s) DejaVu Sans.
      fig.canvas.print_figure(bytes_io, **kw)
    /home/user6182/Regression-Analysis-2026/slides/.venv/lib/python3.14/site-packages/IPython/core/pylabtools.py:170: UserWarning: Glyph 21095 (\N{CJK UNIFIED IDEOGRAPH-5267}) missing from font(s) DejaVu Sans.
      fig.canvas.print_figure(bytes_io, **kw)
    /home/user6182/Regression-Analysis-2026/slides/.venv/lib/python3.14/site-packages/IPython/core/pylabtools.py:170: UserWarning: Glyph 28872 (\N{CJK UNIFIED IDEOGRAPH-70C8}) missing from font(s) DejaVu Sans.
      fig.canvas.print_figure(bytes_io, **kw)
    /home/user6182/Regression-Analysis-2026/slides/.venv/lib/python3.14/site-packages/IPython/core/pylabtools.py:170: UserWarning: Glyph 25238 (\N{CJK UNIFIED IDEOGRAPH-6296}) missing from font(s) DejaVu Sans.
      fig.canvas.print_figure(bytes_io, **kw)
    /home/user6182/Regression-Analysis-2026/slides/.venv/lib/python3.14/site-packages/IPython/core/pylabtools.py:170: UserWarning: Glyph 21160 (\N{CJK UNIFIED IDEOGRAPH-52A8}) missing from font(s) DejaVu Sans.
      fig.canvas.print_figure(bytes_io, **kw)
    /home/user6182/Regression-Analysis-2026/slides/.venv/lib/python3.14/site-packages/IPython/core/pylabtools.py:170: UserWarning: Glyph 65311 (\N{FULLWIDTH QUESTION MARK}) missing from font(s) DejaVu Sans.
      fig.canvas.print_figure(bytes_io, **kw)
...
<table border="1" class="dataframe">
  <thead>
    <tr style="text-align: right;">
      <th></th>
      <th>degree</th>
      <th>mean_prediction_std</th>
      <th>max_prediction_std</th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
<table border="1" class="dataframe">
  <thead>
    <tr style="text-align: right;">
      ...
      <th>RMSE</th>
      <th>MAE</th>
      <th>RMSE/MAE ratio</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <th>0</th>
      <td>clean prediction</td>
      <td>1.000000</td>
      <td>1.0</td>
      <td>1.000000</td>
    </tr>
...
def make_noisy_sample(n=100, noise_std=0.30, rng=None):
    if rng is None:
        rng = np.random.default_rng(42)
    x = rng.uniform(-3, 3, n).reshape(-1, 1)
    y = true_function(x.ravel()) + rng.normal(0, noise_std, n)
...
def polynomial_model_mse(degree):
    return Pipeline([
        ('poly', PolynomialFeatures(degree)),
        ('linear', LinearRegression())
    ])

def polynomial_model_mae(degree):
    return Pipeline([
        ('poly', PolynomialFeatures(degree)),
        ('linear', QuantileRegressor(quantile=0.5, alpha=0, solver='highs'))
    ])
...
# 拟合模型
degree_compare = 6
model_mse = polynomial_model_mse(degree_compare)
model_mse.fit(x_train_c, y_train_c)
y_grid_mse = model_mse.predict(x_grid)

model_mae = polynomial_model_mae(degree_compare)
model_mae.fit(x_train_c, y_train_c)
y_grid_mae = model_mae.predict(x_grid)
...
# 计算并显示结果
mse_train_rmse = root_mean_squared_error(y_train_c, model_mse.predict(x_train_c))
mse_test_rmse = root_mean_squared_error(y_test_c, model_mse.predict(x_test_c))
mae_train_rmse = root_mean_squared_error(y_train_c, model_mae.predict(x_train_c))
mae_test_rmse = root_mean_squared_error(y_test_c, model_mae.predict(x_test_c))
...
print("\nComparison of MSE vs MAE models:")
print(comparison_df)

print(f"\nMSE model test RMSE: {mse_test_rmse:.4f}")
print(f"MAE model test RMSE: {mae_test_rmse:.4f}")
```
...
![png](output_31_0.png)
    ...
    0         MSE (standard)    0.273496   1.142845
    1  MAE (quantile median)    0.275435   1.139634
    
    MSE model test RMSE: 1.1428
    MAE model test RMSE: 1.1396
